...
public class Editor extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        jMenuItem13 = new CopyCommand(jTabbedPane3, this);
        jMenuItem14 = new CutCommand(jTabbedPane3, this);
        jMenuItem15 = new PasteCommand(jTabbedPane3, this);
        jMenuItem16 = new SelectAllCommand(jTabbedPane3, this);
        jMenuItem17 = new IndentCommand(jTabbedPane3, this);
        Undo = new UndoCommand(this);
        jMenu3 = new javax.swing.JMenu();
        jMenuItem1 = new BoldCommand(jTabbedPane3, this);
        jMenuItem2 = new ItalicCommand(jTabbedPane3, this);
        jMenuItem3 = new H1TagCommand(jTabbedPane3, this);
        jMenuItem4 = new H2TagCommand(jTabbedPane3, this);
        jMenuItem5 = new H3TagCommand(jTabbedPane3, this);
        jMenuItem6 = new H4TagCommand(jTabbedPane3, this);
        jMenuItem7 = new H5TagCommand(jTabbedPane3, this);
        jMenuItem8 = new H6TagCommand(jTabbedPane3, this);
        jMenuItem9 = new OrderedListCommand(jTabbedPane3, this);
        jMenuItem10 = new UnorderedListCommand(jTabbedPane3, this);
        jMenuItem11 = new DefinitionListCommand(jTabbedPane3, this);
        jMenuItem12 = new TableTagCommand(jTabbedPane3, this);
        jMenuItem18 = new IMGcommand(jTabbedPane3, this);
        jMenuItem19 = new HREFcommand(jTabbedPane3, list, this);
        ...
        jMenu1.add(SaveAs);
        SaveAs.addActionListener(control);
        ...
        jMenuItem13.addActionListener(control);

        jMenuItem14.setText("Cut");
        jMenu2.add(jMenuItem14);
        jMenuItem14.addActionListener(control);

        jMenuItem15.setText("Paste");
        jMenu2.add(jMenuItem15);
        jMenuItem15.addActionListener(control);

        jMenuItem16.setText("Select All");
        jMenu2.add(jMenuItem16);
        jMenuItem16.addActionListener(control);

        jMenuItem17.setText("Indent");
        jMenu2.add(jMenuItem17);
        jMenuItem17.addActionListener(control);
        ...
        jMenuItem6.addActionListener(control);

        jMenuItem7.setText("H5");
        jMenu3.add(jMenuItem7);
        jMenuItem7.addActionListener(control);

        jMenuItem8.setText("H6");
        jMenu3.add(jMenuItem8);
        jMenuItem8.addActionListener(control);

        jMenuItem9.setText("Ordered List");
        jMenu3.add(jMenuItem9);
        jMenuItem9.addActionListener(control);

        jMenuItem10.setText("UnOrdered List");
        jMenu3.add(jMenuItem10);
        jMenuItem10.addActionListener(control);

        jMenuItem11.setText("Definition List");
        jMenu3.add(jMenuItem11);
        jMenuItem11.addActionListener(control);

        jMenuItem12.setText("Table");
        jMenu3.add(jMenuItem12);
        jMenuItem12.addActionListener(control);

        jMenuItem18.setText("IMG");
        jMenu3.add(jMenuItem18);
        jMenuItem18.addActionListener(control);

        jMenuItem19.setText("HREF");
        jMenu3.add(jMenuItem19);
        jMenuItem19.addActionListener(control);
